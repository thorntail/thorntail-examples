package org.wildfly.swarm.it.messaging.mdb;
...
public class MessagingApplicationIT extends AbstractIntegrationTest {
    ...
    public void testIt() throws Exception {
        ...
        assertThatLog(log).hasLineContaining("WFLYEJB0042: Started message driven bean 'MyTopicMDB' with 'activemq-ra.rar' resource adapter");
