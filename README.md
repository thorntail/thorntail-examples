# JPA and JAX-RS .war Example

This example takes a normal JPA and JAX-RS build, and wraps it into
...
## Run
    ...
    java -jar ./target/wildfly-swarm-example-jpa-jaxrs-1.0.0.Beta1-SNAPSHOT-swarm.jar
