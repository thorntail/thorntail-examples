...
java -jar target/example-xml-config-thorntail.jar -c ../standalone.xml
----
...
java -jar xml-configuration/target/example-xml-config-thorntail.jar
----
...
mvn clean package
java -jar target/example-xml-config-thorntail.jar
----
