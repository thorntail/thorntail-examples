= MicroProfile & ShrinkWrap Example

This examples demonstrates a http://microprofile.io/[MicroProfile]
RESTFul endpoint with a `main()` programatically without
...
to providing all the APIs defined by MicroProfile.
...
* mvn package && java -jar ./target/example-microprofile-shrinkwrap-swarm.jar
